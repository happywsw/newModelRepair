...
public class AlphaMMiner extends LogRelationBasedAlgorithm
{
	...
	HashMap<String, HashMap<String, Integer>>   matrix = null;
	...
	public HashMap<String, HashMap<String, Integer>>   getLogRelations(LogReader logReader){
		mine(logReader);
	...
	public MiningResult mine(LogReader log, LogRelations relations, Progress progress)
	{
		...
		alphaPPData = alphasharp.mineAlphaSharpInfo(log,relations);//alpha#
		
		matrix= alphapp.mineAlphPPInfo(log, alphaPPData, alphasharp.hasInvisibleTask());
