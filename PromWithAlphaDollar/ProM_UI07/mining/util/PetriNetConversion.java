package cn.edu.thss.iise.beehivez.server.mining.util;
...
public class PetriNetConversion {
	...
	public static NetSystem convert(PetriNet _pn) {
...
//				System.out.println(corrCond.getLabel());
	...
	//convert NetSystem into petri net
	public static PetriNet convert(NetSystem ns) {
		...
		for(Flow flow : ns.getFlow()){
			org.processmining.framework.models.petrinet.PNEdge edge;
			if(flow.getSource() instanceof org.jbpt.petri.Transition){
				edge = new org.processmining.framework.models.petrinet.PNEdge((org.processmining.framework.models.petrinet.Transition)nodeMap.get(flow.getSource()), (org.processmining.framework.models.petrinet.Place)nodeMap.get(flow.getTarget()));
				
			}else{
				edge = new org.processmining.framework.models.petrinet.PNEdge((org.processmining.framework.models.petrinet.Place)nodeMap.get(flow.getSource()), (org.processmining.framework.models.petrinet.Transition)nodeMap.get(flow.getTarget()));
			}
